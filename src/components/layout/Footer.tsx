...
const contactLinks = [
  ...
  { label: "contact@coredevai.com", href: "https://mail.google.com/mail/?view=cm&to=contact@coredevai.com", icon: Mail },
...
const socialLinks = [
  ...
  { icon: Mail, href: "https://mail.google.com/mail/?view=cm&to=contact@coredevai.com", label: "Email" },
];
